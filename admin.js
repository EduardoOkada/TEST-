...
function renderProducts() {
  ...
  productList.innerHTML = products.map((product, index) => `
    <article class="admin-product-row">
      ...
      <div class="admin-product-row__body">
        <div class="admin-product-row__name">${product.name}</div>
        <div class="admin-product-row__meta">${product.category} • ${product.tag}</div>
        <div class="admin-product-row__meta">${product.description}</div>
        <div class="admin-product-row__price">${product.price}</div>
      </div>
      <div class="admin-product-row__actions">
        <button type="button" data-edit="${index}">Editar</button>
        <button type="button" class="row-delete" data-delete="${index}">Excluir</button>
      </div>
    </article>
  `).join('');
}
